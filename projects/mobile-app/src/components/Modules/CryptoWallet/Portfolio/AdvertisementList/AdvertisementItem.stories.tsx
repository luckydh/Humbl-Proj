...
export default {
  ...
  title: "CryptoWallet/Components/Portfolio/AdvertisementItem",
  component: AdvertisementItem,
} as Meta;

const Template: Story<AdvertisementItemProps> = (args) => (
  <ul>
    <AdvertisementItem {...args} />
  </ul>
);

const defaultArgs: AdvertisementItemProps = {
  name: "Bitcoin",
  tickerCode: "Buy BTC",
  valueInPercent: 8,
