...
import { GetMarketTopMoversListDocument, MarketSortInput } from "generated/graphql";
import React from "react";

import i18n from "../../../../i18n";
import { GraphQLError } from "graphql";
import { CryptoCurrencyTopMoversWidgetContainer } from "./CryptoCurrencyTopMoversWidgetContainer";
...
describe("Crypo Market Top Movers Container Widget", () => {
  it("Render Crypto Currency List Container Loading State", async () => {
    const mockGetMarketList = createApolloMock(
      ...
      { sortBy: MarketSortInput.TopMovers },
      { data: { getMarketList: { assets: [] } } },
      { addTypename: false }
    );
    const { getByTestId } = render(
      <MockedProvider mocks={[mockGetMarketList]}>
        <CryptoCurrencyTopMoversWidgetContainer />
      </MockedProvider>
    );
    expect(getByTestId("crypto-currency-list-skeleton")).toBeInTheDocument();
  });
  it("Render Crypto Currency Top Movers Container Error State", async () => {
    const mockGetMarketList = createApolloMock(
      GetMarketTopMoversListDocument,
      { sortBy: MarketSortInput.TopMovers },
      {
  ...
  it("Render Crypto Currency Top Movers Container with Data", async () => {
    // Set Feature Flag
    const mockGetMarketList = createApolloMock(
      GetMarketTopMoversListDocument,
      { sortBy: MarketSortInput.TopMovers },
    ...
    await waitFor(() => {
      ...
      expect(getByText("2.54%")).toBeInTheDocument();
  ...
  it("Render Crypto Currency Top Movers and only show first 4 if more passed in.", async () => {
    // Set Feature Flag
    const mockGetMarketList = createApolloMock(
      GetMarketTopMoversListDocument,
      { sortBy: MarketSortInput.TopMovers },
            ...
            assets: [
              ...
              },
              {
                ...
                logoImage:
                  "data:image/svg+xml;base64,",
                price: 2351.990496304068,
                percentChangeOverPeriod: 2.5693917737152845,
                __typename: "AssetMetricType",
              },
              {
                currency: "USD",
                ...
                logoImage:
                  "data:image/svg+xml;base64,",
                price: 2351.990496304068,
                percentChangeOverPeriod: 2.5793917737152845,
                __typename: "AssetMetricType",
              },
              {
                currency: "USD",
                ...
                logoImage:
                  "data:image/svg+xml;base64,",
                price: 2351.990496304068,
                percentChangeOverPeriod: 2.5493917737152845,
                __typename: "AssetMetricType",
              },
              {
                currency: "USD",
                ...
                logoImage:
                  "data:image/svg+xml;base64,",
                price: 2351.990496304068,
                percentChangeOverPeriod: 2.5593917737152845,
                __typename: "AssetMetricType",
              },
            ],
          },
