...
import { PaymentMethodScreen, PaymentMethodScreenProps } from "./PaymentMethodScreen";
import { getFeaturesQueryMock } from "utils/test-helpers/featuresMocks";
import { CreditCard } from "__fixtures__/paymentMethods";
import { RecoilRoot } from "recoil";

export default {
  title: "CryptoWallet/Screens/PaymentMethod",
  component: PaymentMethodScreen,
} as Meta;

const exampleCard = CreditCard;
...
const Template: Story<PaymentMethodScreenProps & { mocks: any[] }> = ({ mocks, ...args }) => (
  <RecoilRoot>
    <MockedProvider mocks={mocks ?? [getFeaturesQueryMock("ach-feature-redux-121521", true)]} addTypename={false}>
      <PaymentMethodScreen {...args} />
    </MockedProvider>
  </RecoilRoot>
);
...
Primary.args = {
  cards: [exampleCard, { ...exampleCard, id: "2", lastFour: "6789", expirationDate: "09/29" }],
  assets: [exampleAsset],
};
